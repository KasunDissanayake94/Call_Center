...
x.addEventListener('click',function(){
   document.getElementById("btnremovelastfield").style.display="block";
	...
	container.innerHTML = 'Name: <input class="form-control" type="text" name="oparr['+count+']['+0+']" value=""  required  pattern="^[A-Za-z0-9 ]*[A-Za-z0-9 ][A-Za-z0-9 ]*$" title="just use numbers or space or alphabet letters" placeholder="Enter field name"><br>'+
