...
function addMoreFields(){
   ...
   var container = document.createElement("div");
	container.innerHTML = '<input class="form-control" pattern="^[A-Za-z0-9 ]*[A-Za-z0-9 ][A-Za-z0-9 ]*$" title="just use numbers or space or alphabet letters"  type="text" name="extraOption[]"><br>';
