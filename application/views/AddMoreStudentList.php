        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
             ...
             if($this->session->flashdata('msg'))
                {
                    $msg = $this->session->flashdata('successfullyAdded');
            ...
            <form action="<?php echo base_url();?>adminController/addMoreStudentsToGroup" method="POST">
            <div class="form-group row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                                    <select name="group" placeholder="Select group" class="form-control" id="sel1" required>
                                    <?php
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-dark btn-block" data-toggle="modal" data-target="#exampleModalLong">Add to existing group</button>
                    </div>
            </div>
            <hr>
            ...
            <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Are you sure to add the seleceted students to the selected group?</div>
