...
function addMoreFields(){
   ...
   var container = document.createElement("div");
	container.innerHTML = '<input class="form-control"   type="text" name="extraOption[]" pattern="^[A-Za-z0-9 ]*[A-Za-z0-9 ][A-Za-z0-9 ]*$"  placeholder="Add More Fields" title="just use numbers or space or alphabet letters"><br>';
