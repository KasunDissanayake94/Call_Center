...
<h4><?php echo $this->session->flashdata('newoptionnotsaved');?></h4>
  ...
  <!-- change the existing field's options -->
    ...
    <div id="newElement"  class="form-group col-md-6"></div>
...
<div class="row-fluid">
    <div class="span12">
        <div style="overflow:hidden;width:90%;">
            ...
            <div style="display:inline-block;width:100px">
			<input class="btn btn-primary" id="btnremovelastfield" type="button" value="Remove Last Field" onclick="removeDiv()"> 
			</div>
...
<script type="text/javascript">
    document.getElementById("btnremovelastfield").style.display="none";
...
x.addEventListener('click',function(){
  document.getElementById("btnremovelastfield").style.display="block";
    currentField = newFieldCount;
    
	var container = document.createElement("div");
	container.innerHTML = 'Name: <input class="form-control" type="text" name="oparr['+count+']['+0+']" value="" pattern="^[A-Za-z0-9 ]*[A-Za-z0-9 ][A-Za-z0-9 ]*$" required  title="just use numbers or space or alphabet letters" placeholder="Enter field name"><br>'+
...
function changeType(currentField,initialDropNum) {
    ...
    if(document.getElementById(textType).value == 'dropdown' || 'checkbox'){
        var container = document.createElement("div");
		container.innerHTML = '<div class="input-group"><span class="input-group-btn"><input type="text" class="form-control" value="" title="just use numbers or space or alphabet letters"  placeholder="Enter field options" title="just use numbers or space or alphabet letters" pattern="^[A-Za-z0-9 ]*[A-Za-z0-9 ][A-Za-z0-9 ]*$"name="oparr['+currentField+'][]"></span><button class="btn btn-primary" type="button"   onclick="changeType('+currentField+','+initialDropNum+')">+</button></div>'
