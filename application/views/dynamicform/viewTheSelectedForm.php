                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url();?>adminController/addStudentManually" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <br><div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="last_name" name="last_name" class="form-control" placeholder="Title" disabled>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="first_name" name="first_name" class="form-control" placeholder="First Name" disabled >
                                    ...
                                    <br><div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="last_name" name="last_name" class="form-control" placeholder="Last Name" disabled>
                                    ...
                                    <br><div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="email" id="inputEmail" name="email" class="form-control" placeholder="Email address" disabled>
                                    ...
                                    <br><div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="mob_number" name="mob_number" class="form-control" placeholder="Mobile Number" disabled >
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="res_number" name="res_number" class="form-control" placeholder="Residence Number" disabled>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="address" name="address" class="form-control" placeholder="Address" disabled>
                                    ...
                                    <?php if($form_field_result){ ?>
                                        <?php foreach($form_field_result as $field){?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-label-group">
                                                    <input disabled type="text" id='.strtolower(str_replace(" ","_",$field->name)).' name='.strtolower(str_replace(" ","_",$field->name)).' class="form-control" placeholder="Email address" required="required">
                                        ...
                                        <br>';
                                            ...
                                            <label for="inputState">'.$field->name.'</label>
                                                ...
                                                foreach($myArray as $option ){
                                                    echo '<input class="form-check-input" disabled type="checkbox" value="'.$option.'" id="'.$option.'">
                            ...
                            <div class="col-md-4">
                                <div class="col-md-12">
                                    <img src="<?php echo base_url();?>assets/img/person.jpg" height="75%" width="75%">
                                    <!--                                <div class="form-group">-->
