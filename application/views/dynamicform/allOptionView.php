...
<?php }else{?>
    ...
    <br>
    <!-- title items -->
    <p class="h2 font-weight-bold">Existing Text Fields</p>
    <h4> Title</h4>
    <div class="row">
<?php if(isset($titletext)){?>
...
<?php foreach($dropdown as $item ){?>  
    <div class="row">
        ...
        <div class="col-md-3">
        <a href="<?php echo base_url() ?>newform/saveNewAllOptions/<?php echo $form_element_id?>/<?php echo $name;?>" class="btn btn-success">ADD MORE </a>
        </div>
    </div>
