            ...
            <div class="row">
              <div class="col-6">
                <div class="p-3 mb-2 bg-light text-dark">
                  <div class="row">
                    <div class="col-9">
                      <p class="left-align"><b>User in-charge: <?php echo $tme_name?></b></p>
                    </div>
                    <div class="col-3">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Change user in-charge?</h5>
              ...
              <div class="col-6">
                  <div class="p-3 mb-2 bg-light text-dark">
                    <div class="row">
                      <div class="col-4">
                      <form id="frm-example1" action="<?php echo base_url();?>adminController/removeStudentsOfLG?group_id=<?php echo $gid?>&group_title=<?php echo $group_title?>" method="POST">
                      ...
                      <div class="col-8">
                        <div class="float-right">
                          ...
                          <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#deleteGroup">Delete whole group</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
<div class="modal fade" id="deleteGroup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            Are you sure to delete the whole group?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a class="btn btn-info" href="deleteLeadsGroup?group_id=<?php echo $gid?>">Yes</a>
      </div>
    </div>
  </div>
</div>
