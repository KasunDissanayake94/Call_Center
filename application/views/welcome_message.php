...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url();?>assets/img/leads.png" type="image/x-icon" />
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <!--</li>-->
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="<?php echo base_url();?>/users/user_login">Signin</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <h1 class="text-uppercase">
                    <strong>Leads Management Portal</strong>
                </h1>
                <hr>
            </div>
