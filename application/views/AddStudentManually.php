      ...
      <select id="inputState" name='title' class="form-control">
        ...
        <option value='Dr'>Dr</option>
                                    ...
                                    <br><div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="mob_number" name="mob_number" pattern="^\d{10}$" class="form-control" placeholder="Mobile Number" >
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input type="text" id="res_number" name="res_number" pattern="^\d{10}$" class="form-control" placeholder="Residence Number" >
                                    ...
                                    <?php if($form_field_result){ ?>
                                        ...
                                        <br>';
                                                ...
                                                echo '<div class="form-row">
                                            <div class="col-md-6">
                                              <b><label for="inputState">'.$field->name.'</label></b>
