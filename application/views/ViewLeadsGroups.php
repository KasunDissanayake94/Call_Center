    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Leads Groups</li>
            </ol>
            ...
            <ul class=\"list-group list-group-flush\">
                <?php
                foreach($leads_groups->result() as $row)
                {
                    echo "
                    
                <li class=\"list-group-item d-flex justify-content-between align-items-center\">$row->title
                <div class=\"btn-group\" role=\"group\" aria-label=\"Basic example\">
                <a class=\"btn btn-outline-info btn-sm\" href=\"viewLeadsGroup?group_id=$row->id&group_title=$row->title&tme_name=$row->first_name $row->last_name\">View details</a>
