                            ...
                            <form action="<?php echo base_url();?>StudentSearch/editStudentBasicDetails" method="POST">
                                    ...
                                    <div class=\"form-row\">
                                        <div class=\"col-md-6\">
                                            ...
                                            <div class=\"form-label-group\">
                                                <input type=\"text\" id='title' value='$perreq->title' name='title' class=\"form-control\" placeholder=\"Title\"  autofocus=\"autofocus\">
                                ...
                                <div class=\"form-group\">
                                    <div class=\"form-row\">
                                        <div class=\"col-md-6\">
                                            ...
                                            <div class=\"form-label-group\">
                                                <input type=\"text\" id='first_name' value='$perreq->first_name' name='first_name' class=\"form-control\" placeholder=\"First name\"  autofocus=\"autofocus\">
                                                <label for='first_name'>First name</label>
                                            </div>
                                        </div>
                                        <input type=\"text\" id=\"id\" name=\"id\" value='$perreq->id' class=\"form-control\" required=\"required\" hidden autofocus=\"autofocus\">
                                        <input type=\"text\" id=\"event_id\" name=\"event_id\" value='$perreq->event_id' class=\"form-control\"  hidden autofocus=\"autofocus\">

                                        <div class=\"col-md-6\">
                                            <div class=\"form-label-group\">
                                                <input type=\"text\" id='last_name' value='$perreq->last_name' name='last_name' class=\"form-control\" placeholder=\"Last name\" >
                                ...
                                <div class=\"form-group\">
                                    <div class=\"form-row\">
                                        <div class=\"col-md-6\">
                                            <div class=\"form-label-group\">
                                                <input type=\"email\" value='$perreq->email'  id='email' name='email' class=\"form-control\" placeholder=\"Email address\">
                                                <label for='email'>Email address</label>
                                            </div>
                                        </div>
                                       <div class=\"col-md-6\">
                                    <div class=\"form-label-group\">
                                        <input type=\"text\" id='address' value='$perreq->address' name='address' class=\"form-control\" placeholder=\"Email address\" >
                                ...
                                <div class=\"form-group\">
                                    <div class=\"form-row\">
                                        ...
                                        <div class=\"col-md-6\">
                                            <div class=\"form-label-group\">
                                                <input type=\"text\" value='$perreq->residence_number' name='residence_number' id='residence_number' class=\"form-control\" placeholder=\"Contact Number\" >
...
$newarraynama=rtrim($arraynama,", ");
                                ...
                                <button class=\"btn btn-primary btn-block\" type=\"submit\" value=\"upload\">Edit Student</button>
                            </div>
                            ";
